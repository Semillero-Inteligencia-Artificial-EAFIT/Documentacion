...
#openai.api_key = "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"
def main():
    ...
    while True:
        try:
            ...
            if not data_queue.empty():
                ...
                result = audio_model.transcribe(temp_file, language="es", fp16=torch.cuda.is_available(), verbose=True)
                ...
                print(transcription)
                for line in [transcription[-1]]:
                    print(line)
                    trad=webTranslate(line,"es","pt")
                    print("Traduccion",trad)
                    speak(trad,"pt")
    ...
    for line in transcription:
        print(line)
        print("Traduccion",webTranslate(line,"es","pt"))
